...
C_SRCS += \
../Application/User/FatFs/diskio.c 

OBJS += \
./Application/User/FatFs/diskio.o 

C_DEPS += \
./Application/User/FatFs/diskio.d 


# Each subdirectory must supply rules for building sources it contributes
Application/User/FatFs/%.o Application/User/FatFs/%.su Application/User/FatFs/%.cyclo: ../Application/User/FatFs/%.c Application/User/FatFs/subdir.mk
...
clean: clean-Application-2f-User-2f-FatFs

clean-Application-2f-User-2f-FatFs:
	-$(RM) ./Application/User/FatFs/diskio.cyclo ./Application/User/FatFs/diskio.d ./Application/User/FatFs/diskio.o ./Application/User/FatFs/diskio.su

.PHONY: clean-Application-2f-User-2f-FatFs
